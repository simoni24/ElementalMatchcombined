...
def Splashs():
   splash = pygame.image.load('splashscreen.jpeg')
...
def Mainmenu():
   mainmenu = pygame.image.load('mainscreen.jpeg')
...
def EarthLevel():
   ...
   while True:  # main game loop
       ...
       drawScore(str(score) + str("    ") + str(Level) + str("    ") + str(movee) + str ("   ") + str(7))
       pygame.display.update()
       FPSCLOCK.tick(FPS)
       # under main loop
...
def instructions():
   instructionss = pygame.image.load('instructions.png')
   instructionss = pygame.transform.scale(instructionss, (1000, 600))
   screen.blit(instructionss, (0, 0))
   pygame.display.update()
...
def losescreen():
   ...
   losescreen = pygame.transform.scale(losescreen, (1000, 600))
   ...
   while True:  # main game loop
       ...
       if gameIsOver:
           ...
           if clickContinueTextSurf == None:
               ...
               clickContinueTextRect.center = int(WINDOWWIDTH / 2), int(WINDOWHEIGHT / 2)
           DISPLAYSURF.blit(clickContinueTextSurf, clickContinueTextRect)
       drawScore(str(score) + str("    ") + str(Level) + str("    ") + str(movee) + str ("   ") + str(11))
       pygame.display.update()
       FPSCLOCK.tick(FPS)
       # under main loop
   ...
   while True:  # main game loop
       ...
       if gameIsOver:
           ...
           if clickContinueTextSurf == None:
               ...
               clickContinueTextRect.center = int(WINDOWWIDTH / 2), int(WINDOWHEIGHT / 2)
           DISPLAYSURF.blit(clickContinueTextSurf, clickContinueTextRect)
       drawScore(str(score) + str("    ") + str(Level) + str("    ") + str(movee) + str ("   ") + str(17))
       pygame.display.update()
       FPSCLOCK.tick(FPS)
       # under main loop
...
def runGame4():
   ...
   while True:  # main game loop
       ...
       if clickedSpace and not firstSelectedGem:
           ...
           pygame.draw.rect(DISPLAY, RED, [675, 500, 255, 45])
           pygame.draw.rect(DISPLAY, YELLOW, [675, 500, 150, 45])
           pygame.draw.rect(DISPLAY, GREEN, [500, 500, 255, 45])
           ...
           if score < 3:
               ...
               pygame.draw.rect(DISPLAY, RED, [675, 500, 0, 45])
           elif score >= 72 and score < 75:
               pygame.draw.rect(DISPLAY, RED, [675, 500, 15, 45])
           elif score >= 75 and score < 78:
               pygame.draw.rect(DISPLAY, RED, [675, 500, 30, 45])
           elif score >= 78 and score < 81:
               pygame.draw.rect(DISPLAY, RED, [675, 500, 40, 45])
           elif score >= 81 and score < 84:
               pygame.draw.rect(DISPLAY, RED, [675, 500, 50, 45])
           elif score >= 84 and score > 87:
               pygame.draw.rect(DISPLAY, RED, [675, 500, 70, 45])
           elif score >= 87 and score < 90:
               pygame.draw.rect(DISPLAY, RED, [675, 500, 90, 45])
           elif score >= 90 and score < 93:
               pygame.draw.rect(DISPLAY, RED, [675, 500, 100, 45])
           elif score >= 93 and score < 96:
               pygame.draw.rect(DISPLAY, RED, [675, 500, 130, 45])
           elif score >= 96 and score < 99:
               pygame.draw.rect(DISPLAY, RED, [675, 500, 150, 45])
           elif score >= 99 and score < 102:
               pygame.draw.rect(DISPLAY, RED, [675, 500, 170, 45])
           elif score >= 102 and score > 105:
               pygame.draw.rect(DISPLAY, RED, [675, 500, 190, 45])
           elif score >= 105 and score < 108:
               pygame.draw.rect(DISPLAY, RED, [675, 500, 220, 45])
           elif score >= 108 and score < 110:
               pygame.draw.rect(DISPLAY, RED, [675, 500, 230, 45])
           elif score >= 110 and score < 113:
               pygame.draw.rect(DISPLAY, RED, [675, 500, 255, 45])
...
def EscapeButton():
    Escape = pygame.Rect(890, 5, 100, 40)
    Escape = pygame.draw.rect(screen, RED, Escape)
    textsurface = BASICFONT.render('Menu', True, BLACK)
    screen.blit(textsurface, (890, 5))

    # Rectplace = pygame.draw.rect(screen, (255, 0, 0), (870, 5, 900, 30))
